...
def load_scan(path):  # 扫描一个患者的目录，加载所有切片，按z的方向排序切片并获取切片厚度
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default='/home/lhl/ct/dataset')
    parser.add_argument('--save_path', type=str, default='/home/lhl/ct/dataset/1')
