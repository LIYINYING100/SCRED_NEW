...
## Updata te
##**********************************************************************************************************
def updata_te(model, te_path):
     print("\n......Please set the path of TE!......")
     if os.path.isfile(te_path):
          print("Te set done, Loading...")
          print("Load model:{}".format(te_path))
          checkpoint = torch.load(te_path, map_location = lambda storage, loc: storage)
